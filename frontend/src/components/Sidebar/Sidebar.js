...
function Sidebar({ color, image, routes }) {
  ...
  const filteredRoutes = routes.filter(
    (route) => !["/login", "/detail-pengajuan", "/transaksi", "/detail-pengajuan-user", "/dok-pengajuan", "/dok-transaksi", "/dok-bpbb", "/dok-surat-jalan", "/pengajuan", "/ubah-pengajuan"].includes(route.path)
  );
