...
import {FaFileCsv, FaFilePdf, FaFileImport, FaLandmark, FaCoins, FaRegEdit, FaDownload, FaTrashAlt, FaHandHoldingUsd, FaUserFriends, FaUserCheck, FaFileContract, FaPlusCircle, FaRecycle, FaPaperclip, FaRegAddressBook, FaRegClone, FaRegClipboard, FaComment, FaArchive, FaRegFileAlt } from 'react-icons/fa'; 
                            ...
                            {currentItems.map((pengajuan) => (
                              <tr key={pengajuan.id_pengajuan}>
                                ...
                                <td className="text-center">
                                  <Button className="btn-fill pull-right info" variant="info" onClick={() => handleDetail(pengajuan)} style={{ width: 103, fontSize: 14 }}>
                                    <FaRegFileAlt style={{ marginRight: '8px' }} />
                                    Detail
                                  </Button>
                                  {/* <Button className="btn-fill pull-right primary mt-2" variant="primary" onClick={() => handleProses(pengajuan)} style={{ width: 103, fontSize: 14 }} hidden={pengajuan.GeneratePengajuan?.status === "Selesai"}>
...
export default DataPengajuanUser;